    ...
    >
      ...
      >
        <div className="text-center mb-8">
          <motion.div
            className="w-16 h-16 bg-indigo-600 rounded-lg flex items-center justify-center mx-auto mb-4"
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="w-full bg-white border-2 border-gray-300 rounded-lg px-6 py-3 flex items-center justify-center space-x-3 hover:border-gray-400 transition mb-4"
        >
